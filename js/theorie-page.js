async function initTheoriePage() {
    ...
    app.innerHTML = `
      <section class="section center-page">
        <div class="card center-card">
          ...
          <h2 style="font-size:20px; margin-top:6px;">Schon bestanden 🎉</h2>
  ...
  renderTheorieQuiz(mount, async (performanceRatio) => {
...
document.addEventListener("DOMContentLoaded", initTheoriePage);

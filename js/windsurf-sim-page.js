async function initWindsurfSimPage() {
  ...
  renderWindsurfSim(mount, day.title, async (performanceRatio) => {
...
document.addEventListener("DOMContentLoaded", initWindsurfSimPage);

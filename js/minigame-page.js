async function initMinigamePage() {
  ...
  app.innerHTML = `
    <section class="section">
      ...
      <div class="card fade-in mg2-shell" id="game-mount" style="margin-top:14px;"></div>
    </section>
  `;

  const mount = document.getElementById("game-mount");
  renderMinigame(mount, day.title, async (performanceRatio) => {
...
document.addEventListener("DOMContentLoaded", initMinigamePage);
